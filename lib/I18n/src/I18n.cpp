...
static constexpr KeyMapping KEY_MAP[] = {
    ...
    {"BOOK_STATS", StrId::STR_BOOK_STATS},
    ...
    {"MENU", StrId::STR_MENU},
    {"PROGRESS", StrId::STR_PROGRESS},
    {"TIME_READ", StrId::STR_TIME_READ},
    {"SESSIONS", StrId::STR_SESSIONS},
    ...
    {"SHOW_RECENTS", StrId::STR_SHOW_RECENTS},
    ...
    {"CLEAR_RECENT", StrId::STR_CLEAR_RECENT},
    ...
    {"CLEAR_RECENT_Q", StrId::STR_CLEAR_RECENT_Q},
    {"CLEAR_RECENT_MSG", StrId::STR_CLEAR_RECENT_MSG},
    ...
    {"PRESS_FILES_TO_EXPLORE", StrId::STR_PRESS_FILES_TO_EXPLORE},
    {"NO_FILES_FOUND", StrId::STR_NO_FILES_FOUND},
    ...
    {"RECENT_BOOKS", StrId::STR_RECENT_BOOKS},
    {"NO_RECENT_BOOKS", StrId::STR_NO_RECENT_BOOKS},
    ...
    {"FIRMWARE_UPDATE", StrId::STR_FIRMWARE_UPDATE},
    {"FIRMWARE_WARNING", StrId::STR_FIRMWARE_WARNING},
    {"FIRMWARE_FILE_FOUND", StrId::STR_FIRMWARE_FILE_FOUND},
    {"FLASHING_UPDATE", StrId::STR_FLASHING_UPDATE},
    {"UPDATE_COMPLETE", StrId::STR_UPDATE_COMPLETE},
    ...
    {"EMPTY_TRASH_MSG1", StrId::STR_EMPTY_TRASH_MSG1},
    {"EMPTY_TRASH_MSG2", StrId::STR_EMPTY_TRASH_MSG2},
    {"EMPTYING_TRASH", StrId::STR_EMPTYING_TRASH},
    {"TRASH_EMPTIED", StrId::STR_TRASH_EMPTIED},
    {"NO_TRASH_TO_EMPTY", StrId::STR_NO_TRASH_TO_EMPTY},
    {"MOVING_TO_TRASH", StrId::STR_MOVING_TO_TRASH},
    {"MOVED_TO_TRASH", StrId::STR_MOVED_TO_TRASH},
    {"MOVE_TO_TRASH_FAILED", StrId::STR_MOVE_TO_TRASH_FAILED},
    {"RESTORING", StrId::STR_RESTORING},
    {"RESTORED", StrId::STR_RESTORED},
    {"RESTORE_FAILED", StrId::STR_RESTORE_FAILED},
    {"CONFIRM_TRASH", StrId::STR_CONFIRM_TRASH},
    {"CONFIRM_RESTORE", StrId::STR_CONFIRM_RESTORE},
    {"MOVE_TO_TRASH_Q", StrId::STR_MOVE_TO_TRASH_Q},
    ...
    {"CONVERTING", StrId::STR_CONVERTING},
    {"CONVERSION_FAILED", StrId::STR_CONVERSION_FAILED},
    {"IMAGE_OPEN_FAILED", StrId::STR_IMAGE_OPEN_FAILED},
    {"IMAGE_INVALID", StrId::STR_IMAGE_INVALID},
    {"WIFI", StrId::STR_WIFI},
    {"SAVED_NETWORKS", StrId::STR_SAVED_NETWORKS},
    {"EDIT_NETWORK", StrId::STR_EDIT_NETWORK},
    {"FORGET_NETWORK", StrId::STR_FORGET_NETWORK},
    {"ENTER_SSID", StrId::STR_ENTER_SSID},
    {"SAVE_FAILED", StrId::STR_SAVE_FAILED},
