...
class Xtc {
 ...
 public:
   ...
   * @return Error code
   */
  xtc::XtcError loadPageStreaming(uint32_t pageIndex, xtc::XtcParser::PageChunkCallback callback,
                                  size_t chunkSize = 1024, const std::function<bool()>& shouldAbort = nullptr) const;
